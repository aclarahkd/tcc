...
class DetalheFoz extends StatefulWidget {
  const DetalheFoz({super.key});

  @override
  State<DetalheFoz> createState() => _DetalheFozState();
}

class _DetalheFozState extends State<DetalheFoz> {
  int _fotoAtual = 0;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Descubra a riqueza natural e cultural da tríplice fronteira em Foz do Iguaçu. Atravesse fronteiras e viva uma experiência junto à fauna e às maravilhas da América do Sul.',
  ...
  Future<void> _abrirWhatsapp() async {
    final uri = Uri.parse('https://wa.me/5512999999999');
