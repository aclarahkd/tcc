                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Column(
                        children: const [
                          Text('"O melhor caminho para o seu destino!"',
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: Stack(
                fit: StackFit.expand,
                children: [
                  Image.asset('imagens/cidaeconrado.jpeg', fit: BoxFit.cover,
                      errorBuilder: (_, __, ___) => Container(
                          color: const Color(0xFF4DA898),
                          child: const Center(child: Icon(Icons.photo, size: 72, color: Colors.white54)))),
                  Positioned(top: 10, left: 12, child: _buildNameTag('Cidinha')),
                  Positioned(top: 10, right: 12, child: _buildNameTag('Conrado')),
                ],
              ),
            ),
          ),
